...
//  4) create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
    modifier whenNotPaused(){
        require(_paused == false , "Contract is out of service");
        _;
    }
    modifier paused (){
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        // TODO require the given address to not be the owner of the tokenId
            require(to != _tokenOwner[tokenId] ,"given address is already owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
            require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId],msg.sender), "you can't transfer from this token");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // TODO: require from address is the owner of the given token
            require(from == ownerOf(tokenId) , "given address do not owen token");
        // TODO: require token is being transfered to valid address
            require(to != address(0), "need valid address");
        // TODO: clear approval
